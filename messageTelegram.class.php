...
class messageTelegram
{
	...
	{
		if( empty( $jsonMessage ) )
		{ throw new Exception( 'A mensagem não pode ser vazia.' ); die(); }
	...
	public static function getJson( $jsonMessage=null )
	{
		...
		{ throw new Exception( 'A mensagem não pode estar vazia.' ); die(); }
	...
	public static function getChatFirstName( $jsonMessage=null )
	{
		$chat = self::getMessageChat( $jsonMessage );
	...
	public static function getChatLastName( $jsonMessage=null )
	{
		$chat = self::getMessageChat( $jsonMessage );
	...
	public static function getChatTitle( $jsonMessage=null )
	{
		$chat = self::getMessageChat( $jsonMessage );
	...
	public static function getMessageInfo( $jsonMessage = null )
	{
		...
		return ( self::isEditedMessage( $json ) ) ?
			$json->edited_message :
			$json->message ??
			$json;// Para os casos de eu já ter passado o message
	}
